export default function ProfilesExample() {
    return (
        <div className="rounded-xl border p-2 md:p-4 w-1/3 md:w-1/6 flex-shrink-0 border-slate-600 backdrop-blur-md bg-[rgba(35,45,60,0.2)]">
            <div className="flex gap-2 md:gap-4 my-2 px-2 md:px-5 md:my-3">
                <svg className="w-8 h-8 " viewBox="0 0 55 53" fill="none" strokeWidth="2.75" xmlns="http://www.w3.org/2000/svg">
