export default function PreviewCard(){
    return(
        <div className="border px-3 md:px-8 md:py-3 mt-32 md:m-10 border-[rgba(255,255,255,0.125)] rounded-3xl backdrop-blur-md bg-[rgba(35,45,60,0.2)] ">
            <div className="flex gap-4 my-3 px-3 md:px-8">
                ...
                <span className="place-self-end self-end font-medium text-xl md:text-2xl">XLink</span>
            </div>
            <div className="my-3 md:my-6 md:mx-14">
