...
export default function FExtras() {
    return (
        <div className="md:px-24 grid my-20 mx-2 md:grid-cols-2 grid-flow-col md:grid-flow-row md:grid-rows-1 grid-rows-2">
            ...
            <div className="relative md:mt-16 mt-12 mr-2 h-52">
                <div className="absolute top-[50%] md:left-40 left-24 w-40 aspect-square border border-slate-500 rounded-3xl backdrop-blur-md dark:bg-[rgba(35,45,60,0.2)] bg-black/0">
                ...
                <div className="absolute -z-10 top-[35%] left-36 md:left-52 w-40 aspect-square border border-slate-500 rounded-3xl backdrop-blur-md dark:bg-[rgba(35,45,60,0.2)] bg-black/0">
