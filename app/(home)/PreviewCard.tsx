export default function PreviewCard(){
    return(
        <div className="border px-3 md:px-8 md:py-3 mt-32 md:m-10 border-[rgba(255,255,255,0.125)] rounded-3xl backdrop-blur-md dark:bg-[rgba(35,45,60,0.2)] bg-black/5">
