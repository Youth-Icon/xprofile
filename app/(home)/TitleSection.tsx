...
export default function TitleSection() {
    return (
        <div className="md:my-44 mx-1">
            ...
            <div className="flex flex-col md:flex-row gap-3 px-0 justify-center items-center">
                <div className="flex">
                    ...
                    <input placeholder="username" className="dark:bg-[rgba(255,255,255,0.94)] bg-black/5 outline-none border-none font-medium md:pr-6 md:py-3 rounded-e-lg dark:text-slate-900" />
                </div>

                <Button variant={'outline'} className={cn("px-6 md:px-6 md:py-3 md:text-base dark:border-slate-600 border-black/40 shadow-sm rounded-full my-auto h-full font-normal")}>
                    Claim Your XProfile
                </Button>
            </div>
        </div>
