...
const ProjectAnalytics: React.FC<ProjectAnalyticsProps> = ({ selectedTimePeriod }) => {
  // Placeholder data
  const profileViews: ProfileView[] = [
    { viewerId: 1, viewedId: 2, timestamp: new Date() },
    { viewerId: 2, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 1)) },
    { viewerId: 3, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 2)) },
    { viewerId: 4, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 3)) },
    { viewerId: 5, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 4)) },
    { viewerId: 6, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 5)) },
    { viewerId: 7, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 6)) },
    { viewerId: 2, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 1)) },
    { viewerId: 3, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 2)) },
    { viewerId: 4, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 3)) },
    { viewerId: 5, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 4)) },
    { viewerId: 6, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 5)) },
    { viewerId: 7, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 6)) },
    { viewerId: 8, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 7)) },
    { viewerId: 9, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 8)) },
    { viewerId: 1, viewedId: 2, timestamp: new Date() },
    { viewerId: 2, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 1)) },
    { viewerId: 3, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 2)) },
    { viewerId: 4, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 3)) },
    ...
    { viewerId: 8, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 7)) },
    { viewerId: 9, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 8)) },
    { viewerId: 10, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 9)) },
    { viewerId: 11, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 10)) },
    { viewerId: 12, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 11)) },
    { viewerId: 13, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 12)) },
    { viewerId: 14, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 13)) },
    { viewerId: 15, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 14)) },
    { viewerId: 16, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 15)) },
    { viewerId: 17, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 16)) },
    { viewerId: 18, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 17)) },
    { viewerId: 19, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 18)) },
    { viewerId: 20, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 19)) },
    { viewerId: 14, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 13)) },
    { viewerId: 15, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 14)) },
    { viewerId: 16, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 15)) },
    { viewerId: 17, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 16)) },
    ...
    { viewerId: 15, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 14)) },
    { viewerId: 16, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 15)) },
    { viewerId: 17, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 17)) },
    { viewerId: 17, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 16)) },
    { viewerId: 17, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 16)) },
    { viewerId: 18, viewedId: 2, timestamp: new Date(new Date().setDate(new Date().getDate() - 17)) },
    { viewerId: 19, viewedId: 1, timestamp: new Date(new Date().setDate(new Date().getDate() - 18)) },
  ...
  const [selectedData, setSelectedData] = useState<{ data: number[]; labels: string[] }>({
    data: [],
    labels: [],
  });
  ...
  const handleTimePeriodChange = (selectedTime: string) => {
    // Instead of modifying the prop directly, update the state
  ...
  const getDataForTimePeriod = (timePeriod: string) => {
    switch (timePeriod) {
      ...
      case "lastMonth":
        ...
        case "last3Months":
            return { data: getLast3MonthsData(), labels: generateLast3MonthsLabels() };
      
          case "last6Months":
            return { data: getLast6MonthsData(), labels: generateLast6MonthsLabels() };
      default:
        return { data: [], labels: [] };
    }
  };
  ...
  const filterViewsByTimePeriod = (views: ProfileView[], timePeriod: string): ProfileView[] => {
    ...
    switch (timePeriod) {
        case "thisWeek":
          ...
          startDate = new Date(currentDate.getTime() - (currentDate.getDay() - 1) * 24 * 60 * 60 * 1000);
          startDate.setHours(0, 0, 0, 0);
          
          // Set the end date to the last second of the last day of the current week
          endDate = new Date(currentDate.getTime() + (7 - currentDate.getDay()) * 24 * 60 * 60 * 1000);
          endDate.setHours(23, 59, 59, 999);
          break;
      
        case "lastWeek":
          // Set the start date to the first second of the first day of the last week
          startDate = new Date(currentDate.getTime() - (currentDate.getDay() + 6) * 24 * 60 * 60 * 1000);
          startDate.setHours(0, 0, 0, 0);
          
          // Set the end date to the last second of the last day of the last week
          endDate = new Date(currentDate.getTime() - currentDate.getDay() * 24 * 60 * 60 * 1000);
          endDate.setHours(23, 59, 59, 999);
          break;
    ...
    return views.filter((view) => view.timestamp >= startDate && view.timestamp <= endDate);
  };
  ...
  const getLast3MonthsData = () => {
    const last3MonthsViews = filterViewsByTimePeriod(profileViews, "last3Months");
    const viewsPerMonth = countViewsPerMonth(last3MonthsViews, 3);
    return generateLast3MonthsLabels().map(month => viewsPerMonth[month] || 0);
  };
  
  const getLast6MonthsData = () => {
    const last6MonthsViews = filterViewsByTimePeriod(profileViews, "last6Months");
    const viewsPerMonth = countViewsPerMonth(last6MonthsViews, 6);
    return generateLast6MonthsLabels().map(month => viewsPerMonth[month] || 0);
  };
  ...
  const countViewsPerDay = (views: ProfileView[]) => {
    const viewsPerDay: Record<string, number> = {};
    views.forEach(view => {
      const day = view.timestamp.toLocaleDateString('en-US', { weekday: 'short' });
      viewsPerDay[day] = (viewsPerDay[day] || 0) + 1;
    });
    return viewsPerDay;
  };
...
return (
    <div className="h-[638px] overflow-hidden relative">
      ...
      <FeatureBox height="auto" width="auto" paddingX="32px" paddingY="32px" style={{ display: "flex", flexDirection: "column" }}>
        <div className="flex justify-between">
          <div className="text-white text-2xl font-semibold font-manrope">Project Analytics</div>
          <div className="w-[193px] h-11 px-4 py-2.5 bg-orange-600 bg-opacity-10 rounded-lg backdrop-blur-[32px] justify-center items-center gap-2.5 inline-flex">
  <div className="text-center text-orange-600 text-lg font-medium font-manrope leading-none">Manage Profile</div>
   <ArrowRight color="rgb(234 88 12)"/>
        ...
        <div className="flex gap-[51px] items-center mt-[48px]">
            ...
            <div className="text-white text-[24px] font-semibold font-manrope">See your profile views</div>
          ...
          <div className="flex gap-[51px]">
            {["thisWeek", "lastWeek", "lastMonth", "last3Months", "last6Months"].map((period) => (
              <FeatureBox key={period} height="142px" width="142px" paddingX="0" paddingY="0">
                <div className="flex flex-col p-[24px] items-center justify-between w-full h-full rounded-3xl hover:bg-slate-300 cursor-pointer " onClick={() => handleTimePeriodChange(period)}>
                <div className="text-center text-white text-[42px] font-bold font-manrope leading-normal">{calculateSumForTimePeriod(period)}</div>
                <div className="text-center text-slate-300 text-opacity-60 text-[14px] font-semibold font-manrope leading-normal">{getFormattedLabel(period)}</div>
                </div>
