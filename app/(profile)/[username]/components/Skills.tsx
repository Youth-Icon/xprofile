...
const Skills = () => {
  ...
  return (
    ...
    >
        <Round className="absolute left-[-6rem] top-[-9rem] w-[400px] h-[400px] shadow-xl opacity-[0.25] bg-[#FF0054] blur-[150px] rounded-full z-10" />
        <Round className="absolute right-[-16rem] top-[1rem] w-[400px] h-[400px] shadow-xl opacity-[0.25] bg-[#FF5400] blur-[150px] rounded-full z-10 " />
