    ...
    return (
        <div className="mt-[8.5rem] flex justify-center items-center bg-cover bg-no-repeat">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center flex flex-col w-full h-full text-6xl lg:text-[76px]">
                ...
                <div className='flex flex-col space-y-3 justify-center items-center'>
                    <div className="text-center max-w-3xl text-stone-400 text-base px-4 sm:text-lg lg:text-[24px] mt-4 sm:mt-6 lg:mt-12 font-medium font-manrope leading-snug">XProfile is an open-source app that provides a one-link portfolio for showcasing your projects, skills, social links, and more.</div>
