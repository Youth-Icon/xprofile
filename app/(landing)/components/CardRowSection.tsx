...
<div className="flex flex-col items-center">
  ...
  <path d="M45 47.15H43.1C41.1 47.15 39.2 47.925 37.8 49.325L33.5249 53.55C31.5749 55.475 28.4 55.475 26.45 53.55L22.175 49.325C20.775 47.925 18.85 47.15 16.875 47.15H15C10.85 47.15 7.5 43.825 7.5 39.725V12.425C7.5 8.325 10.85 5 15 5H45C49.15 5 52.5 8.325 52.5 12.425V39.7C52.5 43.8 49.15 47.15 45 47.15Z" fill="#454545" fill-opacity="0.15" stroke="url(#paint0_linear_139_547)" stroke-width="2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M30.175 22.375C30.075 22.375 29.9249 22.375 29.7999 22.375C27.1749 22.275 25.0999 20.15 25.0999 17.5C25.0999 14.8 27.2749 12.625 29.9749 12.625C32.6749 12.625 34.85 14.825 34.85 17.5C34.875 20.15 32.8 22.3 30.175 22.375Z" stroke="url(#paint1_linear_139_547)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <path d="M23.125 29.8999C19.8 32.1249 19.8 35.7499 23.125 37.9749C26.9 40.4999 33.1 40.4999 36.875 37.9749C40.2 35.7499 40.2 32.1249 36.875 29.8999C33.1 27.3999 26.925 27.3999 23.125 29.8999Z" stroke="url(#paint2_linear_139_547)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
  <defs>
    <linearGradient id="paint0_linear_139_547" x1="-1.35038e-05" y1="-1.49998" x2="72.0607" y2="38.9529" gradientUnits="userSpaceOnUse">
      ...
      <stop offset="0.518161" stop-color="#FF5400"/>
