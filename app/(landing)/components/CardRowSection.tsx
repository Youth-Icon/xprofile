...
const CardRowSection = () => {
  return (
<section>
<div className="w-full pt-8 lg:flex flex-col items-center gap-[32px] overflow-clip hidden lg:visible">
{/* First Row */}
...
<div className="w-full pt-8 flex flex-col items-center gap-[32px] overflow-hidden lg:hidden visible">

{/* Second Row */}
<div className="flex justify-between gap-[10px]">
  <FeatureBox height="362px" width="100px" paddingX="24px" paddingY="28px">
    {/* FeatureBox Content */}
  </FeatureBox>
  <FeatureBox height="362px" width="400px" paddingX="24px" paddingY="28px">
{/* Container with flex layout, aligning items at the center vertically and horizontally */}
<div className="flex flex-col items-center">
